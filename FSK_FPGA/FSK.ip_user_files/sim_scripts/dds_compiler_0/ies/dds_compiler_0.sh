...
#
# Generated by Vivado on Mon Feb 05 10:16:58 +0800 2018
...
# Script info
echo -e "dds_compiler_0.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./dds_compiler_0.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../FSK.srcs/sources_1/ip/dds_compiler_0/sim/dds_compiler_0.vhd" \
...
elaborate()
{
  ...
  libs="-libname secureip -libname xbip_utils_v3_0_5 -libname axi_utils_v2_0_1 -libname xbip_pipe_v3_0_1 -libname xbip_bram18k_v3_0_1 -libname mult_gen_v12_0_10 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_1 -libname xbip_dsp48_multadd_v3_0_1 -libname dds_compiler_v6_0_11 -libname xil_defaultlib"
  ncelab $opts xil_defaultlib.dds_compiler_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.dds_compiler_0 -input simulate.do
}
# Script usage
usage()
{
