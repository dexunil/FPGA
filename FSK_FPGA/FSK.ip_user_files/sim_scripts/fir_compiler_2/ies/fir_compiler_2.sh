...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../FSK.srcs/sources_1/ip/fir_compiler_2/sim/fir_compiler_2.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.fir_compiler_2 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.fir_compiler_2 -input simulate.do
}
# Script usage
usage()
{
